...
ARISA_START_TEXT_VARIANTS = (
    ...
    (
        "D",
        "アリサです。\n"
        "言えないことほど、心に残る。ここでは否定しない。\n"
        "誰にも言ってない本音を、1行だけ置いていって。",
    ),
    (
        "E",
        "アリサ。長い説明はいらないよ。\n"
...
ARISA_SEXY_PROMPT = "秘密の話、ここだけでね…🔥 無理のない範囲で、いまの気分を教えて？"
ARISA_LOVE_PROMPTS = (
    "恋のスイッチ入れよ？💖 いま気になってる人はいる？“一言だけ”で状況教えて。",
    "その気持ち、いちばん近くで聞かせて。今の本音を一言で教えて？",
    "相手との距離、いま“何％”くらいだと思う？",
)
ARISA_SEXY_PROMPTS = (
    "秘密の話、ここだけでね…🔥 無理のない範囲で、いまの気分を教えて？",
    "少し大人の空気にしよ？🥀 いまのムードを一言で教えて？",
...
ARISA_STATUS_ADMIN_LINE = "・管理者: ON"
...
ARISA_STATUS_PASS_TESTER = "30日パス"
ARISA_STATUS_SEXY_UNLOCKED = "・セクシー: 解放済み"
ARISA_STATUS_SEXY_NEEDS_CREDITS = "・セクシー: チケット不足（/storeで追加）"
...
ARISA_PRODUCT_TICKET_7_DESCRIPTION = "状況をもう少し丁寧に読み解きたいときに使えるチケットです。"
...
OPENAI_CONTENT_FALLBACK = "ごめんね、うまく言葉にできないみたい。もう少しだけ教えて？"
